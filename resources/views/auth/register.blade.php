        ...
        <div class="w-full max-w-md rounded-xl border border-border bg-card p-8 shadow-sm">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div class="space-y-1.5">
                    <label for="name" class="text-sm font-medium text-foreground">Prikazno ime</label>
                    <input
                        id="name"
                        name="name"
                        type="text"
                        ...
                        required
                        autofocus
                        class="w-full rounded-md border border-input bg-background px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1 @error('name') border-destructive @enderror"
                    >
                    @error('name')
                ...
                <div class="space-y-1.5">
                    ...
                    <div x-data="{ show: false }" class="relative">
                        ...
                        <button type="button" 
                            tabindex="-1"
                            @click="show = !show" :aria-label="show ? 'Skrij geslo' : 'Pokaži geslo'" class="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground">
                            <template x-if="show">
                ...
                <div class="space-y-1.5">
                    <label for="password_confirmation" class="text-sm font-medium text-foreground">Ponovite geslo</label>
                    <div x-data="{ show: false }" class="relative">
                        <input
                ...
                <div class="flex items-start gap-2">
                    <input id="terms" type="checkbox" required class="mt-0.5 h-4 w-4 rounded border-input text-primary accent-primary">
